...
connect_bd_intf_net -intf_net diff_clock_rtl_0_1 [get_bd_intf_ports diff_clock_rtl_0] [get_bd_intf_pins util_ds_buf/CLK_IN_D]
  ...
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins xdma_0/axi_aclk]
  connect_bd_net -net xdma_0_axi_aresetn [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins xdma_0/axi_aresetn]

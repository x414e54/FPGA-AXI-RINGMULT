//===-- HEIISISelDAGToDAG.cpp - A dag to dag inst selector for HEIIS ------===//
//
...
//===--------------------------------------------------------------------===//
/// HEIISDAGToDAGISel - SPARC specific code to select SPARC machine
/// instructions for SelectionDAG operations.
///
namespace {
class HEIISDAGToDAGISel : public SelectionDAGISel {
  /// Subtarget - Keep a pointer to the HEIIS Subtarget around so that we can
  /// make the right decision when generating code for different targets.
  const HEIISSubtarget *Subtarget;
public:
  explicit HEIISDAGToDAGISel(HEIISTargetMachine &tm) : SelectionDAGISel(tm) {}
...
SDNode* HEIISDAGToDAGISel::getGlobalBaseReg() {
...
bool HEIISDAGToDAGISel::SelectADDRri(SDValue Addr,
...
bool HEIISDAGToDAGISel::SelectADDRrr(SDValue Addr, SDValue &R1, SDValue &R2) {
...
bool HEIISDAGToDAGISel::tryInlineAsm(SDNode *N){
...
void HEIISDAGToDAGISel::Select(SDNode *N) {
  SDLoc dl(N);
...
/// inline asm expressions.
bool
HEIISDAGToDAGISel::SelectInlineAsmMemoryOperand(const SDValue &Op,
                                                unsigned ConstraintID,
...
/// createHEIISISelDag - This pass converts a legalized DAG into a
/// SPARC-specific DAG, ready for instruction scheduling.
///
FunctionPass *llvm::createHEIISISelDag(HEIISTargetMachine &TM) {
  return new HEIISDAGToDAGISel(TM);
}

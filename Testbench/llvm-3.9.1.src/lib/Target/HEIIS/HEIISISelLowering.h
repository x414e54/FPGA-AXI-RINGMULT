//===-- HEIISISelLowering.h - HEIIS DAG Lowering Interface ------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the interfaces that HEIIS uses to lower LLVM code into a
// selection DAG.
//
//===----------------------------------------------------------------------===//
...
namespace llvm {
  ...
  class HEIISTargetLowering : public TargetLowering {
    const HEIISSubtarget *Subtarget;
  public:
    HEIISTargetLowering(const TargetMachine &TM, const HEIISSubtarget &STI);

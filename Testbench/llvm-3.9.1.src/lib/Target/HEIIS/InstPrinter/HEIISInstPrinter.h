//===-- HEIISInstPrinter.h - Convert HEIIS MCInst to assembly syntax ------===//
//
...
class HEIISInstPrinter : public MCInstPrinter {
public:
  HEIISInstPrinter(const MCAsmInfo &MAI, const MCInstrInfo &MII,
  ...
  bool printHEIISAliasInstr(const MCInst *MI, const MCSubtargetInfo &STI,
                            raw_ostream &OS);

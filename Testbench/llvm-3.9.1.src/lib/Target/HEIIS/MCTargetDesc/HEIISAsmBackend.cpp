//===-- HEIISAsmBackend.cpp - HEIIS Assembler Backend ---------------------===//
//
...
static unsigned adjustFixupValue(unsigned Kind, uint64_t Value) {
  ...
  case HEIIS::fixup_sparc_wplt30:
  case HEIIS::fixup_sparc_call30:
    return (Value >> 2) & 0x3fffffff;

  case HEIIS::fixup_sparc_br22:
    return (Value >> 2) & 0x3fffff;

  case HEIIS::fixup_sparc_br19:
    return (Value >> 2) & 0x7ffff;

  case HEIIS::fixup_sparc_br16_2:
    return (Value >> 2) & 0xc000;

  case HEIIS::fixup_sparc_br16_14:
    return (Value >> 2) & 0x3fff;

  case HEIIS::fixup_sparc_pc22:
  case HEIIS::fixup_sparc_got22:
  case HEIIS::fixup_sparc_tls_gd_hi22:
  case HEIIS::fixup_sparc_tls_ldm_hi22:
  case HEIIS::fixup_sparc_tls_ie_hi22:
  case HEIIS::fixup_sparc_hi22:
    return (Value >> 10) & 0x3fffff;

  case HEIIS::fixup_sparc_pc10:
  case HEIIS::fixup_sparc_got10:
  case HEIIS::fixup_sparc_tls_gd_lo10:
  case HEIIS::fixup_sparc_tls_ldm_lo10:
  case HEIIS::fixup_sparc_tls_ie_lo10:
  case HEIIS::fixup_sparc_lo10:
    return Value & 0x3ff;

  case HEIIS::fixup_sparc_tls_ldo_hix22:
  case HEIIS::fixup_sparc_tls_le_hix22:
    return (~Value >> 10) & 0x3fffff;

  case HEIIS::fixup_sparc_tls_ldo_lox10:
  case HEIIS::fixup_sparc_tls_le_lox10:
    return (~(~Value & 0x3ff)) & 0x1fff;

  case HEIIS::fixup_sparc_h44:
    return (Value >> 22) & 0x3fffff;

  case HEIIS::fixup_sparc_m44:
    return (Value >> 12) & 0x3ff;

  case HEIIS::fixup_sparc_l44:
    return Value & 0xfff;

  case HEIIS::fixup_sparc_hh:
    return (Value >> 42) & 0x3fffff;

  case HEIIS::fixup_sparc_hm:
    return (Value >> 32) & 0x3ff;

  case HEIIS::fixup_sparc_tls_gd_add:
  case HEIIS::fixup_sparc_tls_gd_call:
  case HEIIS::fixup_sparc_tls_ldm_add:
  case HEIIS::fixup_sparc_tls_ldm_call:
  case HEIIS::fixup_sparc_tls_ldo_add:
  case HEIIS::fixup_sparc_tls_ie_ld:
  case HEIIS::fixup_sparc_tls_ie_ldx:
  case HEIIS::fixup_sparc_tls_ie_add:
    return 0;
  }
}

namespace {
  class HEIISAsmBackend : public MCAsmBackend {
  protected:
  ...
  public:
    HEIISAsmBackend(const Target &T)
    ...
    unsigned getNumFixupKinds() const override {
      return HEIIS::NumTargetFixupKinds;
    }

    const MCFixupKindInfo &getFixupKindInfo(MCFixupKind Kind) const override {
      const static MCFixupKindInfo InfosBE[HEIIS::NumTargetFixupKinds] = {
      ...
      const static MCFixupKindInfo InfosLE[HEIIS::NumTargetFixupKinds] = {
        // name                    offset bits  flags
    ...
    void processFixupValue(const MCAssembler &Asm, const MCAsmLayout &Layout,
      ...
      switch ((HEIIS::Fixups)Fixup.getKind()) {
      default: break;
      case HEIIS::fixup_sparc_wplt30:
      ...
      case HEIIS::fixup_sparc_tls_ie_add:
      case HEIIS::fixup_sparc_tls_le_hix22:
      case HEIIS::fixup_sparc_tls_le_lox10:  IsResolved = false; break;
      }
    }
  ...
  class ELFHEIISAsmBackend : public HEIISAsmBackend {
    Triple::OSType OSType;
  public:
    ELFHEIISAsmBackend(const Target &T, Triple::OSType OSType) :
      HEIISAsmBackend(T), OSType(OSType) { }
    ...
    MCObjectWriter *createObjectWriter(raw_pwrite_stream &OS) const override {
      ...
      return createHEIISELFObjectWriter(OS, Is64Bit, IsLittleEndian, OSABI);
    }
  };

} // end anonymous namespace

MCAsmBackend *llvm::createHEIISAsmBackend(const Target &T,
                                          const MCRegisterInfo &MRI,
                                          const Triple &TT, StringRef CPU) {
  return new ELFHEIISAsmBackend(T, TT.getOS());
}

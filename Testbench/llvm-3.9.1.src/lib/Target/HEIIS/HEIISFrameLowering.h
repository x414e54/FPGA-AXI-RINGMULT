//===-- HEIISFrameLowering.h - Define frame lowering for HEIIS --*- C++ -*-===//
//
...
class HEIISFrameLowering : public TargetFrameLowering {
public:
  explicit HEIISFrameLowering(const HEIISSubtarget &ST);

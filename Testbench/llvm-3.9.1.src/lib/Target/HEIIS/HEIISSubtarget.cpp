//===-- HEIISSubtarget.cpp - SPARC Subtarget Information ------------------===//
//
...
void HEIISSubtarget::anchor() { }

HEIISSubtarget &HEIISSubtarget::initializeSubtargetDependencies(StringRef CPU,
                                                                StringRef FS) {
  IsV9 = false;
  IsLeon = false;
...
HEIISSubtarget::HEIISSubtarget(const Triple &TT, const std::string &CPU,
                               const std::string &FS, const TargetMachine &TM,
                               bool is64Bit)
    : HEIISGenSubtargetInfo(TT, CPU, FS), TargetTriple(TT), Is64Bit(is64Bit),
      InstrInfo(initializeSubtargetDependencies(CPU, FS)), TLInfo(TM, *this),
      FrameLowering(*this) {}

int HEIISSubtarget::getAdjustedFrameSize(int frameSize) const {
...
bool HEIISSubtarget::enableMachineScheduler() const {
  return true;
}
